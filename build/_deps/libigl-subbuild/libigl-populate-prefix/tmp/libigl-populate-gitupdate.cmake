...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref "v2.5.0"
  WORKING_DIRECTORY "/Users/davidepaollilo/Workspaces/C++/CustomRenderer/build/_deps/libigl-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/davidepaollilo/Workspaces/C++/CustomRenderer/build/_deps/libigl-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/davidepaollilo/Workspaces/C++/CustomRenderer/build/_deps/libigl-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
